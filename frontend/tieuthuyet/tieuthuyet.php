...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="container-fluid">
            <h3>Danh sách chương tiểu thuyết <?= $truyentranhRow['truyen_ten'] ?></h3>
            <div class="row">
                <div class="col">
                    <ul>
                        <?php foreach($danhsachchuong as $chuong): ?>
                            <a href="/proj-truyentranh/frontend/tieuthuyet/tieuthuyet-noidung.php?truyen_id=<?= $truyentranhRow['truyen_id'] ?>&chuong_id=<?= $chuong['chuong_id'] ?>">
