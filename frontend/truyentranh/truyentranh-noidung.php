        ...
        <div class="row">
            <div class="col">
                ...
                <h3>Chương <?= $truyentranhRow['chuong_sochuong'] ?> - <?= $truyentranhRow['chuong_ten'] ?></h3>
                    ...
                    <a href="truyentranh.php?truyen_id=<?= $truyentranhRow['truyen_id'] ?>" class="btn btn-outline-primary">Quay về danh sách chương</a>
                    <button name="btnPrevious" id="btnPrevious" class="btn btn-primary">Chương sau</button>
