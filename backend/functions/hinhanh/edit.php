...
<main role="main">
            ...
            <div class="col-md-8">
                ...
                <form name="frmUpdate" id="frmUpdate" method="post" action="" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <img src="/proj-truyentranh/assets/uploads/products/<?= $hinhanhRow['hinhanh_ten']; ?>" id="preview-img" width="200px" />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="chuong_id" name="chuong_id">
                            <?php foreach ($dataChuong as $chuong) : ?>                              
                                <?php if ($chuong['chuong_id'] == $hinhanhRow['chuong_id']) : ?>
                                    <option value="<?= $chuong['chuong_id'] ?>" selected><?= $chuong['chuong_ten'] ?></option>
                                <?php else : ?>
    ...
    <?php
        ...
        if (isset($_POST['btnSave'])) {           
            ...
            // Câu lệnh UPDATE        
            $sqlUpdate = "UPDATE `hinhanh` SET hinhanh_ten='$tentaptin', chuong_id='$chuong_id' WHERE hinhanh_id=$hinhanh_id;";
